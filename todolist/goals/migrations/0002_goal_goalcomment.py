    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'toDO'), (2, 'in progress'), (3, 'done'), (4, 'arhived')], default=1)),
                ('priory', models.PositiveSmallIntegerField(choices=[(1, 'L'), (2, 'M'), (3, 'H'), (4, 'C')], default=1)),
                ('due_date', models.DateField(blank=True, null=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='goals', to='goals.goalcategory')),
